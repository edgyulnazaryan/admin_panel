 $(document).ready(function() {
    ...
    $("#toast-success").on("click", function() {
            ...
            toastr.info("Info!', 'Please Read the Instructions Carefully")
        }), $("#toast-warning").on("click", function() {
            toastr.warning("Warning!', 'Battery Charging low")
        }), $("#toast-error").on("click", function() {
            toastr.error("Danger!', 'Your record has been deleted")
        }),
        // top position
        ...
        $("#toast-position-bottom-left").on("click", function() {
            ...
            toastr.info("toastr is a Javascript library for non-blocking notifications. jQuery is required!", "John Says")
        }),
